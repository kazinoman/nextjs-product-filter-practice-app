export default function ProductLoading() {
  ...
  return (
    <>
      <div className="grid grid-cols-4  overflow-hidden rounded-xl  animate-pulse">
        <div className="m-2 border p-2 rounded-md">
          <div className="group relative block h-48 overflow-hidden bg-gray-200 md:h-64 rounded-md mt-2"></div>
